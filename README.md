...
1. Extract this ZIP
2. Open **Android Studio** → `File > Open` → select `Java/`
3. Wait for Gradle sync to finish
4. Edit `app/src/main/java/com/tes/aop/MainActivity.java`
...
2. Upload/push the contents of `Java/` to the `main` branch
3. GitHub Actions will automatically build the APK
4. Download the APK from the **Actions → Artifacts** tab

> **Debug APK**: `Java-debug`  
> **Release APK**: `Java-release-unsigned`
