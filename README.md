...
1. Extract this ZIP
2. Open **Android Studio** → `File > Open` → select `Tesuh/`
3. Wait for Gradle sync to finish
4. Edit `app/src/main/java/com/mm/mm/MainActivity.java`
...
2. Upload/push the contents of `Tesuh/` to the `main` branch
3. GitHub Actions will automatically build the APK
4. Download the APK from the **Actions → Artifacts** tab

> **Debug APK**: `Tesuh-debug`  
> **Release APK**: `Tesuh-release-unsigned`
